...
public class RobotTimed extends TimedRobot {
	...
	public void robotInit() {
		...
		e_frontLeft = new Encoder(kFrontLeftEncoderA, kFrontLeftEncoderB, false, Encoder.EncodingType.k1X);
		e_rearLeft = new Encoder(kRearLeftEncoderA, kRearLeftEncoderB, false, Encoder.EncodingType.k1X);
    ...
    public void testPeriodic() {
    	...
    	System.out.format("X Position: %.2f  %.2f", m_robotEncoder.getPositionX(), m_robotEncoder.getPositionY());
    	m_lastTime = now;
    }
